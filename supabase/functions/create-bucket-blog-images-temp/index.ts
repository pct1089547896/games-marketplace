...
Deno.serve(async (req) => {
    ...
    const policyQueries = [
        ...
        `CREATE POLICY "Public Upload for blog-images" ON storage.objects FOR INSERT WITH CHECK (bucket_id = 'blog-images');`,
        // Allow public to update objects in this bucket
        `CREATE POLICY "Public Update for blog-images" ON storage.objects FOR UPDATE USING (bucket_id = 'blog-images');`,
        // Allow public to delete objects in this bucket
        `CREATE POLICY "Public Delete for blog-images" ON storage.objects FOR DELETE USING (bucket_id = 'blog-images');`
    ];
